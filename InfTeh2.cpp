...
// InfTeh2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CInfTeh2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CInfTeh2App

CInfTeh2App::CInfTeh2App()
{
...
// Единственный объект CInfTeh2App

CInfTeh2App theApp;


// Инициализация CInfTeh2App

BOOL CInfTeh2App::InitInstance()
{
